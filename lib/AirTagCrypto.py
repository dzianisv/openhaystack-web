...
# distributed with this repository in the LICENSE file at the repository root,
...
class AirTagCrypto:
    """OpenHaystack key derivation and report decryption.
    ...
    def get_advertisement_key(self) -> str:
        ...
        if len(public_key) != 28:
            raise ValueError(f"Derived advertisement key must be 28 bytes, got {len(public_key)}")
